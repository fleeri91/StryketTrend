      ...
      <Dialog as='div' className='relative z-10' onClose={onClose}>
        ...
        <div className='fixed inset-0 overflow-y-auto'>
          <div className='flex min-h-full items-center justify-center p-12 text-center'>
            ...
            >
              <Dialog.Panel className='dark:bg-gray-950 dark:text-white w-full transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                <Dialog.Title
                  as='h3'
